...
uint16_t ble_svc_hid_get_kbd_inp_handle(int instance);
uint16_t ble_svc_hid_get_report_handle(int instance, uint8_t id, uint8_t type);
int ble_svc_hid_report_data_set(int instance, uint8_t id, uint8_t type,
